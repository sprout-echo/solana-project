...
} from "./chunk-FVOZTBRF.js";
import "./chunk-Z3UAXL6Y.js";
import "./chunk-THTHAMA4.js";
import "./chunk-73PI7QCL.js";
...
function createInitializeInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:initialize_account"), getStructEncoder2([
...
function createUpdateFieldInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:updating_field"), getStructEncoder2([
...
function createRemoveKeyInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:remove_key_ix"), getStructEncoder2([
...
function createUpdateAuthorityInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:update_the_authority"), getStructEncoder2([["newAuthority", getPublicKeyEncoder2()]])).encode({ newAuthority: newAuthority ?? SystemProgram.programId }))
  });
}
function createEmitInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:emitter"), getStructEncoder2([
